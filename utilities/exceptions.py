...
Contains exceptions used by foxford.
...
class FoxfordException(Exception):
    """
    Base exception for all of foxford.
    """
    pass
...
class ResponseError:
    """
    Represents an error returned by a Foxford server.
...
# HTTP exceptions
# Exceptions that Foxford endpoints do not respond with are not included here.

class HTTPException(FoxfordException):
    """
    ...
    Attributes:
        ...
        errors: A list of Foxford response errors.
    """
...
class TooManyRequests(HTTPException):
    ...
    This means that Foxford has [ratelimited](https://en.wikipedia.org/wiki/Rate_limiting) you.
    """
    pass
...
class InternalServerError(HTTPException):
    ...
    This usually means that there was an issue on Foxford's end, but due to faulty coding on Foxford's part this can
